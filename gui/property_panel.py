...
class PropertyPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.form_layout.addRow("弹性系数 e (0~1):", self.sp_restitution)
        self.form_layout.addRow("摩擦系数 μ (0~1):", self.sp_friction)
        ...
        self.form_layout.addRow("刚度 k (与伸长量比例):", self.sp_stiffness)
        self.form_layout.addRow("阻尼 d (与相对速度比例):", self.sp_damping)
