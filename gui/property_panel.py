...
class PropertyPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.form_layout.addRow("厚度:", self.sp_thickness)
    ...
    def update_from_object(self):
        ...
        self.sp_thickness.setVisible(is_groove); self.form_layout.labelForField(self.sp_thickness).setVisible(is_groove)
